...
class VBEPostings:
    ...
    def encode(postings_list):
        ...
        """
        # TODO
        # Convert postings_list to list of gaps
        gaps = [0 for _ in postings_list]
        gaps[0] = postings_list[0]
        for i in range(1,len(postings_list)):
            gaps[i] = postings_list[i] - postings_list[i-1]

        # Convert list of gaps to encoded & compressed bytearray
    ...
    def vb_encode(list_of_numbers):
        ...
        for number in list_of_numbers:
            ans += VBEPostings.vb_encode_number(number)
        return ans
    ...
    def decode(encoded_postings_list):
        ...
        """
        # TODO
        ans = VBEPostings.vb_decode(encoded_postings_list)
        cnt = 0
